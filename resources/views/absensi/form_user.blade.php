<div class="row">
    <div class="col-12">
        <div class="form-group">
            <label>Tanggal</label>
            <input type="text" class="flatpickr-daterange form-control" name="date" placeholder="Pick date range" id="absensi-date" value="{{ Carbon\Carbon::now()->format('Y-m-d') }}" disabled>
        </div>
