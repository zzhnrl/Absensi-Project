    ...
    <table cellspacing="0" border="1" width="100%" style="border-collapse: collapse;">
        <thead>
            <tr class="table-header">
                <th class="table-border text-center" style="padding: 8px;">Bulan</th>
                <th class="table-border text-center" style="padding: 8px;">Tahun</th>
                <th class="table-border text-center" style="padding: 8px;">Nama Karyawan</th>
                <th class="table-border text-center" style="padding: 8px;">Jumlah Izin Sakit</th>
            </tr>
        </thead>
        <tbody>
            @foreach ($izin_sakits as $izin_sakit)
                <tr>
                    <td class="table-border text-center" style="padding: 6px;">{{ $izin_sakit['bulan'] }}</td>
                    <td class="table-border text-left" style="padding: 6px;">{{ $izin_sakit['tahun'] }}</td>
                    <td class="table-border text-left" style="padding: 6px;">{{ $izin_sakit['nama_karyawan'] }}</td>
                    <td class="table-border text-center" style="padding: 6px;">{{ $izin_sakit['jumlah_izin_sakit'] }}
                    </td>
                </tr>
            @endforeach
        </tbody>
